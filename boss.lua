...
function RichardHeart.PoisonBoltVolley(eventId, delay, calls, creature)
    creature:CastSpell(creature:GetVictim(), 40095, true)
end

function RichardHeart.CastHatefulStrike(eventId, delay, calls, creature)
    creature:CastSpell(creature:GetVictim(), 28308, true)
end

function RichardHeart.CastGore(eventId, delay, calls, creature)
...
function RichardHeart.OnEnterCombat(event, creature, target)
    ...
    creature:RegisterEvent(RichardHeart.PoisonBoltVolley, 7000, 0)
    creature:RegisterEvent(RichardHeart.CastHatefulStrike, 15000, 0)
    creature:RegisterEvent(RichardHeart.CastGore, 20000, 0)
...
function RichardHeart.CheckHealth(event, creature, world)
    ...
    if currentPhase == 4 then
       -- creature:CanAggro(false)
        ...
        creature:MoveTo(1, 2462, 2574, 25)
